...
This is a seeded senior-lab input for C4 and Sequence Diagram From Code. It gives the learner concrete constraints to inspect, implement, test, and verify.
