...
See [COMPETENCY_PRACTICE_GUIDE.md](./COMPETENCY_PRACTICE_GUIDE.md) for the competency definitions and practice behaviors, and [SENIOR_AGENTIC_ENGINEERING_RUBRIC.md](./SENIOR_AGENTIC_ENGINEERING_RUBRIC.md) for the shared completion bar.
...
See [REAL_WORLD_VALIDATION.md](./REAL_WORLD_VALIDATION.md) for the current competency-practice genuineness audit.
...
| 03. Context Engineering | 04 | [Imported NFR X-Ray](./03%20Context%20Engineering/exercise-04-imported-nfr-x-ray/README.md) | Imported and converted React + TypeScript starter |
...
| 07. Docs & Diagrams | 04 | [Imported Generate Diagram](./07%20Docs%20&%20Diagrams/exercise-04-imported-generate-diagram/README.md) | Imported and converted React + TypeScript starter |
...
| 09. Code Review | 04 | [Imported Code Review](./09%20Code%20Review/exercise-04-imported-code-review/README.md) | Imported and converted React + TypeScript starter |
...
Three imported starter exercises are included under their closest competencies:

- NFR X-Ray -> 03 Context Engineering
- Generate Diagram -> 07 Docs & Diagrams
- Code Review -> 09 Code Review
