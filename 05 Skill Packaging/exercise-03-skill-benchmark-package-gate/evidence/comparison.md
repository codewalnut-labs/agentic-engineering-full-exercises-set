...
The quality figures are assertion-level grading results, not evidence that the baseline lost facts or that the candidate reduced false positives. The retained baseline outputs show citation and format failures while preserving the cited recovery, unresolved causes, and open follow-up in the inspected examples. The defensible improvement claim is improved contract compliance and consistency.
