...
Chronology note: the revised description was committed in `86cef5f` before these retained September 9 sessions began. These records are post-review validation of the already-frozen description, not the historical baseline that motivated its edit. The recorded training and held-out false positives are observations supporting the catalog-boundary rationale; they were not used to retune this description.
