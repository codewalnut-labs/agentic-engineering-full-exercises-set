# Release Prompt History

This is a seeded senior-lab input for Release Notes Skill Factory. It gives the learner concrete constraints to inspect, implement, test, and verify.
