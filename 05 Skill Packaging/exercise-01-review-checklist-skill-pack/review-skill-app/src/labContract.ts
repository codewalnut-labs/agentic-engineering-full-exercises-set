...
export const labContract: LabContract = {
  ...
  "mission": "Package a repeated code review checklist into a focused skill and use it against the provided app change.",
  ...
  "masterySignals": [
    ...
    "Run the skill against the provided app change and capture findings.",
