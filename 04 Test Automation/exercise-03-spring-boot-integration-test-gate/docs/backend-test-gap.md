...
This is a seeded senior-lab input for Spring Boot Integration Test Gate. It gives the learner concrete constraints to inspect, implement, test, and verify.
