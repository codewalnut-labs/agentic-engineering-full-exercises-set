...
This is a seeded senior-lab input for Component Tests With Network Boundaries. It gives the learner concrete constraints to inspect, implement, test, and verify.
