...
```text
09 Code Review/exercise-04-pr-diff-review/starter-react
```
...
```text
09 Code Review/exercise-04-pr-diff-review/pr/review-target.diff
```
...
- Review the supplied PR diff under a timebox.
