...
if (!patch.includes("dangerouslySetInnerHTML") || !patch.includes("reviewPolicy.ts")) throw new Error("Review patch is missing seeded security or policy changes");
const temp = mkdtempSync(path.join(tmpdir(), "review-fixture-"));
try {
...
console.log(`Review fixture verified: ${manifest.comparison}`);
