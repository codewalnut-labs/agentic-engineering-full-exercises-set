...
This map captures popular agent skill patterns that are useful for advanced agentic engineering practice. Some exercises use public skills or tools directly; others teach the underlying workflow pattern so teams can adapt it to their own agent surface.
...
| diagnosing-bugs | Reproduce, minimize, instrument, fix, and regression-test failures before changing broad code. | 04 Test Automation / Exercise 01 |
...
| code-review | Review generated diffs against repo standards and originating spec with clean evidence. | 09 Code Review / Exercise 02 |
